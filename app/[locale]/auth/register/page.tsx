    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center space-y-1">
          <h1 className="text-2xl font-semibold text-neutral-100">{t("auth.registerTitle")}</h1>
          <p className="text-sm text-neutral-500">Start analysing financial documents for free</p>
        </div>
